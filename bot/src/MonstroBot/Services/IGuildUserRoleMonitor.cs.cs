...
public class GuildUserRoleMonitor(ILogger<GuildUserRoleMonitor> logger, IGuildLoggingService guildLoggingService, MonstroBotDbContext dbContext) : IGuildUserRoleMonitorService
{
